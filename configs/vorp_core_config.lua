...
Config = {
    ...
    DeleteFromUsersTable  = false, -- this will delete from users table if character does not exist "optimising the queries"
    -----------------------------------------------------
    ...
    initInvCapacity       = 100.0,         -- Initial number of character inventory weight for new players. for old characters you must change in the database if you dont ave a new server
