...
Config.Locale = {
    ["en"] = {
        ["you_are_busy"] = "You are busy!", -- NEW!
        ["eventActivated"] = "The ${value}x fish event is active so you get more fish!", -- NEW!
        ["you_need_upgrade_fishingrod"] = "You can level up your fishing rod!",
        ["use_fishingrod"] = "15 seconds to choose the fishing rod you want to change your enchantment!",
        ["use_fishingrod2"] = "15 seconds to choose the fishing rod you want to upgrade!",
        ["leveled_up"] = "Your fishing rod has leveled up! You can go to the blacksmith and improve your fishing rod.",
        ["upgrade"] = "Upgrade",
        ["start_fishing"] = "Fishing",
        ["use_bait"] = "Use Bait",
        ["cancel"] = "Cancel",
        ["blacksmith"] = "Blacksmith",
        ["goblacksmith"] = "go to the blacksmith first !",
        ["selectupgraderod"] = "Within 15 seconds, use the fishing rod you want to raise !",
        ["selecetupgradeitem"] = "Within 15 seconds, use the upgrade item you want to raise !",
        ["nobait"] = "No bait in your bag !",
        ["upgradesuccess"] = "Upgrade success !",
        ["successfish"] = "You got the ${fishName} and won ${xp}xp !",
        ["you_are_not_in_area"] = "You're not in the fishing zone!",
        ["fishing_failed"] = "You failed to catch fish!",
        ["upgrade_failed"] = "Upgrade failed!",
        ["you_dont_have_a_items"] = "You don't have your things!",
        ["fishingrod_max"] = "This fishing rod is already at maximum !",
        ["need_first_xp"] = "You need to earn XP first.",
        ["fishingrod_description"] = "Current Level ${currentLevel}<br>XP : ${currentXP}/${neededXP}<br>Probability of Catching Big Fish +${bigFishLuck}%<br>Probability of Catching Valuable Fish +${worthyFishLuck}%",
        ["nojob"] = "You dont have a job !",
        ["minigame_hook"] =         "HOOK!",
        ["minigame_success"] =   "SUCCESS",
        ["minigame_fail"] =   "FAIL",
        ["minigame_got_away2"] =   "GOT AWAY",
        ["minigame_fish_on"] =   "FISH ON!",
        ["minigame_too_soon"] =   "TOO EARLY!",
        ["minigame_controls_reel"] =   "Hook/Reel!",
        ["minigame_controls_exit"] =   "Exit Fishing!",
        ["notadmin"] = "You are not admin !",
        ["error_invalid_rod"] = "Exp could not be given. Transaction invalid reuse the fishing rod you want to fish !",
        ["efsunsuccess"] = "Efsun is successful. ~COLOR_YELLOW~${bigchance}% ~COLOR_WHITE~chance of big fish and ~COLOR_YELLOW~${smallchance}% ~COLOR_WHITE~chance of small fish !",
    }
}
