...
Config.animalSetup = {
    cow = {--Setting the key to the model, database column, etc.
        ...
        productMale = "provision_meat_prime_beef",--What is the item ID for products.
        ...
        troughDataDrink = {
            ...
            ["water"] = {10, 20, "Water in bottle"},
            ["wateringcan"] = {10, 20, "Water in bottle", "wateringcan_empty", 10},
        },
        ...
        healthData = {
            ...
            ["vaccine_livestock"] = {1, 100, "Livestock Vaccine"},
        },
    ...
    chicken = {
        ...
        ageForProduct = 5,
        productFemale = "egg",
        productMale = "provision_meat_plump_bird",
        productFor100 = 0.5,
        takeProduct = 20,
    ...
    sheep = {
        ...
        countProduct = 2,
        ageForProduct = 5,
        productFemale = "provision_sheep_wool",
        productMale = "provision_meat_gristly_mutton",
        productFor100 = 0.5,
        takeProduct = 20,
    ...
    goat = {
        ...
        troughDataFood = {
            ["consumable_apple"] = {40, 40, "consumable_apples"},
        },
        troughDataDrink = {
            ["water"] = {10, 20, "Water with bottle"},
        },

        hungerDrain = {0.50, 1.50},
        foodData = {
            ["consumable_apple"] = {4, 40, "consumable_apples"},
        },
        
        thirstDrain = {0.50, 1.50},
        waterData = {
            ["water"] = {1, 20, "Water with bottle"},
        },
        
        healthDrain = {0.010, 0.050},
        healthData = {
            ["vaccine_livestock"] = {1, 100, "Heath Injection"},
        },
    ...
    horse = {
        ...
        troughDataFood = {
            ["consumable_herb_consumable_herb_wild_carrotss"] = {40, 40, "Wild Carrot"},
            ["consumable_carrot"] = {40, 40, "Carrot"},
        },
        troughDataDrink = {
            ["water"] = {10, 20, "Water in bottle"},
        },
        ...
        hungerDrain = {0.50, 1.50},
        foodData = {
            ["consumable_herb_wild_carrots"] = {4, 40, "Wild Carrot"},
            ["consumable_carrot"] = {40, 40, "Carrot"},
        },
    ...
    pig = {
        ...
        countProduct = 2,
        ageForProduct = 5,
        productFemale = "provision_meat_tender_pork",
        productMale = "leather",
        productFor100 = 0.5,
        takeProduct = 20,
        ...
        healthDrain = {0.010, 0.050},
        healthData = {
            ["vaccine_livestock"] = {1, 100, "Health injection"},
        },
