Config.FarmHerbs = {
	...
	["seed_wheat"] = {
		...
		herbToSeed = 3,
		herbName = "Orange",
		herbItem = "crop_orange",
		itIsTree = true,
		canPickAfterGrow = 0,
		potStageProps = {
			[1] = {"p_tree_orange_01", 301, 3.0},
			[2] = {"p_tree_orange_01", 250, 2.2},
			[3] = {"p_tree_orange_01", 100, 1.4},
		...
		herbToSeed = 3,
		herbName = "Cherry",
		herbItem = "crop_cherry",
		itIsTree = false,
		canPickAfterGrow = 0,
		potStageProps = {
			[1] = {"rdr_bush_decor_aa", 301, 3.0},
		...
		herbToSeed = 3,
		herbName = "Tomato",
		herbItem = "crop_tomato",
		itIsTree = false,
		canPickAfterGrow = 0,
		potStageProps = {
			[1] = {"crp_tomatoes_aa_sim", 301, 3.0},
			[2] = {"crp_tomatoes_aa_sim", 250, 2.2},
			[3] = {"crp_tomatoes_aa_sim", 100, 1.4},
		...
		herbToSeed = 3,
		herbName = "Sugarcane",
		herbItem = "crop_sugarcane",
		itIsTree = false,
		canPickAfterGrow = 0,
		potStageProps = {
			[1] = {"crp_sugarcane_ac_sim", 301, 3.0},
			[2] = {"crp_sugarcane_ac_sim", 250, 2.2},
			[3] = {"crp_sugarcane_ac_sim", 100, 1.4},
		...
		herbItem = "crop_tobacco",
		itIsTree = false,
		canPickAfterGrow = 0,
		potStageProps = {
			[1] = {"crp_tobaccoplant_bc_sim", 301, 3.0},
			[2] = {"crp_tobaccoplant_bc_sim", 250, 2.2},
			[3] = {"crp_tobaccoplant_bc_sim", 100, 1.4},
