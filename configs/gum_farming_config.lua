...
Config.plantSetting = {
	...
	updateTime = 15,--15 minutes for update all herbs status and save to database
	canPlantEverywhere = true,--With false you can plant only on free farms or job farms
    ...
    disableHoe = false, --If true you can plant without hoe
	locationTempAffect = true,--If true location affect temperature Config.TemperatureDiscrict
    weatherAffect = true, --If true weather affect while grow (watering while raining weather)
	...
	maxHerbOutOfHome = 30,--Max herbs out of home
	...
	-- Jerk Setting
	jerkChance = 15,--15% chance to get jerk
	jerkHowMuchGet = {1,10},--Get 2-10 Pests 15%
	jerkDecreaseQuality = 0.3,--Decrease quality of herb(for every 1% Pests max is 100%)
	jerkDecreaseProcure = 1.0,--Decrease state of herb (for every 1% Pests max is 100%)
...
Config.Language = {
	...
	thisYouCantHerePlant = 'You cant plat this seed tpye here',
...
Config.AnimationsDelay = {
	...
	destroyLand = 2,
	markAnimation = 1.8,
	prepareAnimation = 5.1, --default 9.1
	jerksAnimation = 4,
	fertilizeAnimation = 4, --default 8
	procureAnimation = 4, --default 8
	makeHerbAnimation = {3, 4}, --default {8,8}
